 ...
 */
export const getTextWithHighestFeatureScore = (textItems, featureSets, returnEmptyStringIfHighestScoreIsNotPositive = true, returnConcatenatedStringForTextsWithSameHighestScore = false) => {
