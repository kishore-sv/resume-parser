...
export const hasOnlyLettersSpacesAmpersands = (item) => /^[A-Za-z\s&]+$/.test(item.text);
export const hasLetterAndIsAllUpperCase = (item) => hasLetter(item) && item.text.toUpperCase() === item.text;
// Date Features
