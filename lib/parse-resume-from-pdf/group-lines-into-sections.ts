import type { ResumeKey } from "../parse-resume-from-pdf/extract-resume-from-sections/types.js";
import type {
  Line,
  Lines,
  ResumeSectionToLines,
} from "../parse-resume-from-pdf/extract-resume-from-sections/types.js";
