import type { ResumeSectionToLines } from "../../parse-resume-from-pdf/extract-resume-from-sections/types.js";
...
} from "../../parse-resume-from-pdf/extract-resume-from-sections/lib/bullet-points.js";
import type { ResumeSkills } from "./types.js";

// Generate placeholder featured skills (instead of Redux initial state)
const createEmptyFeaturedSkills = (count: number) =>
  Array.from({ length: count }, () => ({ skill: "" }));
