// Getting pdfjs to work is tricky. The following lines make it work in Node.js
import pdfjsLib from "pdfjs-dist/legacy/build/pdf.js";

import type { TextItem as PdfjsTextItem } from "pdfjs-dist/types/src/display/api.js";
import type { TextItem, TextItems } from "../parse-resume-from-pdf/extract-resume-from-sections/types.js";
